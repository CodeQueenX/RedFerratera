    ...
    <div class="accordion-item border rounded shadow-sm mb-3">
        ...
        <div id="faqGeneral" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body">
                ...
                <p><strong>¿Cómo funciona la web?</strong><br>
                Cualquier usuario puede consultar ferratas, pero para añadir o modificar información necesitas registrarte.</p>
            </div>
        </div>
    </div>
    ...
    <div class="accordion-item border rounded shadow-sm mb-3">
        ...
        <div id="faqCuentas" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body">
                ...
                <p><strong>Olvidé mi contraseña, ¿cómo la recupero?</strong><br>
                Ve a la página de "Iniciar Sesión" y haz clic en "¿Olvidaste tu contraseña?". Introduce tu email y recibirás instrucciones para cambiarla.</p>
            </div>
        </div>
    </div>
    ...
    <div class="accordion-item border rounded shadow-sm mb-3">
        ...
        <div id="faqModeracion" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
            <div class="accordion-body">
                ...
                <p><strong>¿Cómo puedo convertirme en moderador?</strong><br>
                Por ahora, solo los administradores pueden asignar roles de moderador a usuarios confiables.</p>
            </div>
        </div>
    </div>
